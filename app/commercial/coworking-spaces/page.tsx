...
const FALLBACK = {
  ...
  impactDescription:
    "Our coworking space photography directly impacts occupancy rates and membership conversion. Spaces featuring Nashray's imagery consistently see 50-70% increases in virtual tour engagement and 40% higher conversion rates from inquiry to membership. By visually communicating the community vibe, amenity quality, and professional environment, we help operators attract the right members and justify premium pricing in competitive markets.",
  galleryImages: [
    {
