...
async function getPortfolioCategory() {
  ...
  return (data as any)?.["custom-interiors"] ?? null;
}
...
const FALLBACK = {
  ...
  categoryFilters: [
    { id: "all", label: "All" },
    { id: "architectural-elements", label: "Architectural", href: "/custom-interiors/architectural-elements-photography-dubai" },
    { id: "custom-furniture", label: "Furniture", href: "/custom-interiors/custom-furniture-photography-dubai" },
    { id: "materials", label: "Materials", href: "/custom-interiors/material-closeups-photography-dubai" },
    { id: "design-details", label: "Details", href: "/custom-interiors/design-details-photography-dubai" },
  ],
