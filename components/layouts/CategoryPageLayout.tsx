    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="portfolio" className="py-16 md:py-24 px-6 md:px-16 bg-stone-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-3 md:gap-6 mb-12 md:mb-20 px-4 md:px-0 max-w-4xl mx-auto">
            {categoryFilters
              ...
              .map((filter) => (
                <Link
                  key={filter.id}
                  href={filter.href!}
                  className="group relative w-full sm:w-auto sm:flex-1 sm:min-w-[180px] sm:max-w-[240px] px-6 md:px-10 py-3.5 md:py-5 border border-stone-300 text-stone-700 hover:border-stone-900 hover:text-stone-900 transition-all duration-500 text-xs md:text-sm font-medium tracking-wide md:tracking-[0.2em] uppercase overflow-hidden text-center"
                >
                  ...
                  <span className="absolute inset-0 z-10 flex items-center justify-center opacity-0 group-hover:opacity-100 text-white transition-opacity duration-500 tracking-wide md:tracking-[0.2em]">
                    {filter.label}
                  </span>
                </Link>
              ))}
