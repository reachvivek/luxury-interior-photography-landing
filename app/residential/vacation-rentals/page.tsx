...
const FALLBACK = {
  ...
  approachDescription:
    "Vacation rental photography differs fundamentally from traditional real estate photography - it sells experiences, not just spaces. Nashray understands what drives Airbnb and vacation rental bookings: lifestyle imagery showing how guests will live, comprehensive amenity coverage demonstrating value, location context highlighting convenience, and aspirational moments that create emotional connections. Our photography answers the question 'What will my stay be like?' before guests even arrive, directly impacting your booking rates and nightly rates.",
