          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:flex-shrink-0">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center px-8 py-3.5 border-2 border-white text-white hover:bg-white hover:text-stone-900 transition-all duration-300 text-sm font-medium tracking-wide rounded-full backdrop-blur-sm"
                >
                  Get in Touch
                </Link>
              </div>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center px-6 md:px-16">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="inline-block px-10 py-4 border-2 border-white text-white hover:bg-white hover:text-stone-900 transition-all duration-300 text-sm font-medium tracking-widest uppercase rounded-full"
            >
              Get in Touch
            </Link>
          </div>
