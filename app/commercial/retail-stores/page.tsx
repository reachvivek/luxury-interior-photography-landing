...
async function getSubcategoryData() {
  try {
    ...
    return (record?.data as any)?.commercial?.subcategories?.["retail-stores"] ?? null;
  } catch {
    return null;
  }
}
