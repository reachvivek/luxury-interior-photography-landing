...
const FALLBACK = {
  ...
  impactDescription:
    "Professional office photography delivers measurable ROI through multiple channels. Companies using Nashray's office imagery in recruitment materials report 45% higher application rates from qualified candidates. Commercial real estate listings featuring our photography lease 30% faster and command rental premiums, while corporate websites with professional workspace imagery see significantly improved client conversion rates and longer visitor engagement.",
  galleryImages: [
    {
