...
async function getSubcategoryData() {
  ...
  return (data as any)?.["custom-interiors"]?.subcategories?.materials ?? null;
}
...
const FALLBACK = {
  ...
  impactDescription: "Our material photography transforms specification sheets into compelling visual stories that close sales. Material suppliers and luxury brands using MyVisual.Space's imagery report that clients make confident purchasing decisions faster, reducing sales cycles by 25-35%. These images become essential marketing assets - demonstrating quality differences that justify premium pricing and helping clients visualize how materials will elevate their projects to exceptional status.",
  galleryImages: [
    {
...
export default async function MaterialsPage() {
  ...
  const videos = await getServiceVideos("custom-interiors/material-closeups");
