...
export default function EventSpacesPage() {
  return (
    <SubcategoryPage
      ...
      impactDescription="Our event space photography directly impacts venue booking rates by helping planners envision their perfect event. Venues showcasing Tsurov's imagery report 50-65% increases in qualified inquiries and 35% higher conversion rates from site visits to bookings. By presenting spaces that inspire emotional connections and practical confidence, we help venues command premium pricing and secure high-value corporate contracts and destination weddings."
      galleryImages={[
        {
