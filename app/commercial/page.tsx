...
async function getPortfolioCategory() {
  ...
  return (data as any)?.commercial ?? null;
}
...
const FALLBACK = {
  ...
  categoryFilters: [
    { id: "all", label: "All" },
    { id: "office-spaces", label: "Office Spaces", href: "/commercial/office-spaces-photography-dubai" },
    { id: "coworking-spaces", label: "Co-working Spaces", href: "/commercial/coworking-spaces-photography-dubai" },
    { id: "retail-stores", label: "Retail Stores", href: "/commercial/retail-stores-photography-dubai" },
    { id: "showrooms", label: "Showrooms", href: "/commercial/showrooms-photography-dubai" },
  ],
