...
async function getSubcategoryData() {
  ...
  return (data as any)?.commercial?.subcategories?.showrooms ?? null;
}
...
export default async function ShowroomsPage() {
  ...
  const videos = await getServiceVideos("commercial/showrooms");
