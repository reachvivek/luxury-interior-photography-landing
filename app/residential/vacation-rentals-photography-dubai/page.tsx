...
const FALLBACK = {
  ...
  description:
    "Specialized photography for Airbnb and vacation rental properties that drives bookings, showcasing lifestyle amenities, location highlights, and guest experiences that convert browsers into bookers.",
  ...
  approachDescription:
    "Vacation rental photography differs fundamentally from traditional real estate photography - it sells experiences, not just spaces. MyVisual.Space understands what drives Airbnb and vacation rental bookings: lifestyle imagery showing how guests will live, comprehensive amenity coverage demonstrating value, location context highlighting convenience, and aspirational moments that create emotional connections. Our photography answers the question 'What will my stay be like?' before guests even arrive, directly impacting your booking rates and nightly rates.",
...
export default async function VacationRentalsPage() {
  ...
  const videos = await getServiceVideos("residential/vacation-rentals");
